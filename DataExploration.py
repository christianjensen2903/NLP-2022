...
class DataExploration():
    ...
    def find_frequent_words(self):
        ...
        zip_words = lambda word_counts, sort_indices: list(zip(word_counts[0][sort_indices],word_counts[1][sort_indices],word_counts[1][sort_indices] / sentence_count)) # Zip the most frequent words with its number of occurences
